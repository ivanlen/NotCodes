...
class CarliniL2:
    def __init__(self, sess, model,
        ...
        # self.assign_timg = tf.Variable(dtype=tf.float32, shape=shape)
        # self.assign_tlab = tf.Variable(dtype=tf.float32, shape=(batch_size, num_labels))
        # self.assign_const = tf.Variable(dtype=tf.float32, shape=[batch_size])
